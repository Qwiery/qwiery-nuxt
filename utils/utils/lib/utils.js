...
export const Utils = {
	 ...
	 */
	getEdgeSpecs(sourceId, targetId = null, data = null, id = null, labels = null) {
	...
	getTripleSpecs(s, p, o) {
		...
		if (_.isArray(s)) {
			if (s.length === 3) {
				...
				throw new Error("Triple specification should be an array of length 3 or as SPO arguments.");
			}
		}
		s = s.toString().trim();
		if (!_.isNil(p)) {
