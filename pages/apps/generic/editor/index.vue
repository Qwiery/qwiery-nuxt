	...
	<splitpanes class="!h-[85vh] overflow-hidden" :push-other-panes="false">
		...
		<pane size="60">
			<splitpanes horizontal>
				...
				<pane size="10" v-if="isBottomVisible">
					<div class="border-t border-white-light dark:border-primary">
						...
						<div>
							<apexchart ref="chart" type="area" height="200" width="100%" :options="chartOptionsYears" :series="seriesYears"></apexchart>
						</div>
					</div>
				</pane>
			</splitpanes>
...
<script setup lang="ts">
	...
	onMounted(() => {
		...
		initController();
		// const c = <any>(<unknown>chart.value);
		// setTimeout(() => {
		// 	//split panes issue
		// 	c.chart.render();
		// }, 800);
